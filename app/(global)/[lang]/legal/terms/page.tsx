        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg mb-8">
            ...
            <p className="text-sm">
              ...
              <Link href="/us/legal/terms" className="text-blue-600 hover:text-blue-800 underline">
                US Terms of Service
              </Link>.
            </p>
          </div>
          ...
          <section className="mb-8">
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg mt-6">
              ...
              <p className="text-sm">
                ...
                <Link href="/us/legal/terms" className="text-purple-600 hover:text-purple-800 underline">
                  US Terms of Service
                </Link> which are governed by Wyoming state law and US federal regulations.
              </p>
            </div>
          </section>
        </div>
